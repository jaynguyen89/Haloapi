...
public partial class Locality {
    ...
    public Locality(string id, string name, byte region, string isoCode2Char, string isoCode3Char, string telephoneCode, string primaryCurrencyId, string? secondaryCurrencyId) {
        Id = id;
        Name = name;
        Region = region;
