...
public partial class HalogenDbContext : DbContext {
    ...
    public HalogenDbContext(DbContextOptions<HalogenDbContext> options): base(options) { }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "UQ__Account__3214EC06CFC2BF1B")
                .IsUnique();
            ...
            entity.Property(e => e.EmailAddressToken).HasMaxLength(30);
        ...
        modelBuilder.Entity<Locality>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "UQ__Locality__3214EC064E7F360A")
                .IsUnique();
        ...
        modelBuilder.Entity<Preference>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "UQ__Preferen__3214EC069DEF4E06")
                .IsUnique();
            ...
            entity.Property(e => e.Privacy).HasMaxLength(1000);

            entity.Property(e => e.Security).HasMaxLength(1000);
        ...
        modelBuilder.Entity<Profile>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "UQ__Profile__3214EC06C4268F0A")
                .IsUnique();
            ...
            entity.Property(e => e.PhoneNumberToken).HasMaxLength(30);
        ...
        modelBuilder.Entity<TrustedDevice>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "UQ__TrustedD__3214EC06AB260CC6")
                .IsUnique();
